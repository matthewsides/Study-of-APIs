...
With regards to platform or system compatability, the current plans are for the game to be based and developed for PC only, though it will also allow for controller input, meaning that the game can be played with a controller in addition to the keyboard and mouse.
