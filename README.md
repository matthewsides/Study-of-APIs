...
For the purpose of this project the API that was decided upon was the scripting API provided by Unity. This API provides numerous  classes with pre-defined functions for development. For instance the 
